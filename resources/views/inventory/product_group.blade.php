                            ...
                            <form action="{{url('/post_products')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="ps-3 pe-3 row">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-6  col-xl-6  text-uppercase mb-3">
                                        <label class="mb-2" for="product_name">Product Group Name: </label>
                                        <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Product Group Name " required>
                                    </div>

                                    <div class="col-12 col-md-6 col-lg-6  col-xl-6  text-uppercase mb-3">
                                        <label class="mb-2" for="ratings">Product UPC Code:</label>
                                ...
                                <div class="d-flex align-items-center justify-content-between ">
                                    <h3>Products</h3>
                                    <span class="btn btn-dark" onclick="add_new_product_input()">+Add Product</span>
                                </div>
                                <div id="product_group">
                                    <div class=" ps-3 pe-3 product_container__ d-none" id="temp_product">

                                        <hr style="height:5px; color:#245423;">
                                        <div class="row">
                                    ...
                                    <div class=" ps-3 pe-3 product_container__">
                                ...
                                <script>
                                    let product_group = document.querySelector('#product_group');
                                    const add_new_product_input = () => {
                                        let again = document.querySelector('#temp_product').cloneNode(true);
                                        again.classList.remove('d-none');
                                        product_group.appendChild(again);
                                    }
                                </script>
